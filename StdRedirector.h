#ifndef STDREDIRECTOR
#define STDREDIRECTOR

// Credits:
// http://www.qtforum.org/article/24554/displaying-std-cout-in-a-text-box.html?d56d6d32#post86997
// Posted by "stinos"
...
public:
	...
	*/
	StdRedirector( std::ostream &a_Stream , pfncb a_Cb , void *a_pUsrData ) : m_Stream( a_Stream )
	{
		m_pCbFunc = a_Cb;
